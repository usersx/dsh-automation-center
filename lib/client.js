  ...
  return {
    ...
    async createAutomation(input) {
      ...
      if (clientRequestId === void 0) {
        clientRequestId = globalThis.crypto?.randomUUID?.() ?? `request_${Date.now()}_${Math.random().toString(36).slice(2)}`;
    ...
    async updateAutomation(automationId, expectedRevision, input) {
      const payload = { automationId, expectedRevision, input };
      await mutateThenRefresh("update", payload);
    },
    async mutateAutomation(automationId, mutation) {
      const payload = { automationId, mutation };
...
function AutomationCard(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("article", { className: "dsh-automation-card", children: [
    ...
    confirmingDelete ? /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dsh-automation-delete-confirm", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("button", { className: "dsh-automation-button dsh-automation-button--ghost", type: "button", onClick: () => onRun(automation.id), disabled: isBusy, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dsh-automation-content", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("section", { className: "dsh-automation-main-column", children: [
        ...
        filteredSnapshot?.automations.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dsh-automation-empty", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("button", { className: "dsh-automation-button dsh-automation-button--primary", type: "button", onClick: () => setShowCreate(true), children: [
