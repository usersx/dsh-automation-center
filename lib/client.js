...
function AutomationSidebarAction({
  ...
  const attention = state.snapshot?.runs.filter((run) => run.unread !== false && (run.status === "failed" || run.status === "interrupted" || run.status === "skipped")).length ?? 0;
...
function AutomationCard(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("article", { className: "dsh-automation-card", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dsh-automation-card-title", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dsh-automation-card-badges", children: [
            ...
            automation.health.status === "blocked" && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "dsh-automation-health-badge", children: t("card.blocked") })
          ] })
        ] })
      ] }),
    ...
    automation.health.status === "blocked" && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dsh-automation-health", role: "status", children: [
