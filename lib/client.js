window.__ModuleLoader__.load({ id: "dsh-automation-center", factory: (require) => {
...
__export(index_exports, {
  ...
  inject: () => inject,
  name: () => name,
  registerAutomationSurface: () => registerAutomationSurface
});
...
var en = {
  ...
  "notification.title": "Automation needs attention",
  "notification.body": "{name} has a result to review.",
  ...
  "form.reviewMode": "Execution mode",
  "form.reviewDirect": "Direct workspace",
  "form.reviewWorktree": "Git review worktree",
  "form.reviewDirectHint": "Run directly in the registered workspace.",
  "form.reviewWorktreeHint": "Run in an isolated detached worktree, then accept, keep, or discard the patch.",
  ...
  "form.nextPreview": "Next run: {time} \xB7 {zone}",
  ...
  "form.error.review": "Git review worktree requires Workspace write permission.",
  "day.1": "Mon",
  "day.2": "Tue",
  "day.3": "Wed",
  "day.4": "Thu",
  ...
  "card.reviewWorktree": "Git review",
  ...
  "run.effectUnknown": "Side-effect outcome needs reconciliation",
  "run.reviewPending": "Review patch is ready",
  "run.reviewAccept": "Accept",
  "run.reviewKeep": "Keep worktree",
  "run.reviewDiscard": "Discard",
  "run.reviewSettling": "Review cleanup is settling",
  "run.reviewCleanupUnknown": "Review cleanup needs reconciliation",
  "run.reviewAcceptConfirm": "Apply this patch to the clean source checkout?",
  "run.reviewDiscardConfirm": "Permanently discard this isolated worktree?",
  "outcome.pending": "Pending outcome",
  "outcome.unknown": "Outcome not reported",
  "outcome.no_change": "No change",
  "outcome.changes_ready": "Changes ready",
  "outcome.needs_input": "Needs input",
  ...
  "outcome.partial": "Partial result",
...
var zh = {
  ...
  "notification.title": "\u81EA\u52A8\u5316\u9700\u8981\u5173\u6CE8",
  "notification.body": "{name} \u6709\u4E00\u6761\u7ED3\u679C\u9700\u8981\u5904\u7406\u3002",
  ...
  "form.timeout": "\u8FD0\u884C\u8D85\u65F6",
  "form.reviewMode": "\u6267\u884C\u6A21\u5F0F",
  "form.reviewDirect": "\u76F4\u63A5\u5DE5\u4F5C\u533A",
  "form.reviewWorktree": "Git \u9694\u79BB\u5BA1\u9605",
  "form.reviewDirectHint": "\u76F4\u63A5\u5728\u5DF2\u6CE8\u518C\u5DE5\u4F5C\u533A\u4E2D\u8FD0\u884C\u3002",
  "form.reviewWorktreeHint": "\u5728\u72EC\u7ACB detached worktree \u4E2D\u8FD0\u884C\uFF0C\u5B8C\u6210\u540E\u53EF\u63A5\u53D7\u3001\u4FDD\u7559\u6216\u4E22\u5F03\u8865\u4E01\u3002",
  ...
  "form.days": "\u661F\u671F",
  "form.timeZone": "\u65F6\u533A",
  "form.nextPreview": "\u9884\u8BA1\u4E0B\u6B21\u8FD0\u884C\uFF1A{time} \xB7 {zone}",
  ...
  "form.error.review": "Git \u9694\u79BB\u5BA1\u9605\u9700\u8981\u201C\u53EF\u5199\u5DE5\u4F5C\u533A\u201D\u6743\u9650\u3002",
  "day.1": "\u5468\u4E00",
  "day.2": "\u5468\u4E8C",
  "day.3": "\u5468\u4E09",
  "day.4": "\u5468\u56DB",
  ...
  "run.attempt": "\u7B2C {count} \u6B21\u5C1D\u8BD5",
  "run.effectUnknown": "\u526F\u4F5C\u7528\u7ED3\u679C\u9700\u8981\u5BF9\u8D26",
  "run.reviewPending": "\u5BA1\u9605\u8865\u4E01\u5DF2\u5C31\u7EEA",
  "run.reviewAccept": "\u63A5\u53D7",
  "run.reviewKeep": "\u4FDD\u7559 worktree",
  "run.reviewDiscard": "\u4E22\u5F03",
  "run.reviewSettling": "\u5BA1\u9605\u8D44\u6E90\u6B63\u5728\u6E05\u7406",
  "run.reviewCleanupUnknown": "\u5BA1\u9605\u8D44\u6E90\u9700\u8981\u5BF9\u8D26",
  "run.reviewAcceptConfirm": "\u5C06\u6B64\u8865\u4E01\u5E94\u7528\u5230\u5E72\u51C0\u7684\u6E90\u5DE5\u4F5C\u533A\u5417\uFF1F",
  "run.reviewDiscardConfirm": "\u6C38\u4E45\u4E22\u5F03\u8FD9\u4E2A\u9694\u79BB worktree \u5417\uFF1F",
  "outcome.pending": "\u7ED3\u679C\u5F85\u5B9A",
  "outcome.unknown": "\u672A\u62A5\u544A\u7ED3\u6784\u5316\u7ED3\u679C",
  "outcome.no_change": "\u65E0\u9700\u53D8\u66F4",
  "outcome.changes_ready": "\u53D8\u66F4\u5F85\u5BA1\u9605",
  "outcome.needs_input": "\u9700\u8981\u8F93\u5165",
...
function unwrapRpcResult(value) {
  ...
  if (result.ok === false && "error" in result) {
    ...
    const failure = new Error(error?.message ?? "The automation request failed.");
    failure.name = error?.code ?? "automation-error";
    throw failure;
  }
  throw new Error("The automation host returned an invalid response.");
}
...
var CHANNEL = "/dsh-automation-center";
function createAutomationRuntime(rpc) {
  let state = { phase: "idle" };
  let refreshPromise;
  const listeners = /* @__PURE__ */ new Set();
  const createRequestIds = /* @__PURE__ */ new Map();
  const publish = (next) => {
    state = next;
  ...
  const mutateThenRefresh = async (endpoint, payload) => {
    const receipt = unwrapRpcResult(await rpc.call(CHANNEL, endpoint, payload));
    if (receipt.outcome !== "committed") {
      ...
      if (receipt.outcome === "unknown") {
        const pendingBeforeRefresh2 = refreshPromise;
        if (pendingBeforeRefresh2 !== void 0) await pendingBeforeRefresh2.catch(() => void 0);
  ...
  const requestId = () => globalThis.crypto?.randomUUID?.() ?? `request_${Date.now()}_${Math.random().toString(36).slice(2)}`;
  const markRunRead = async (runId) => {
    const payload = { runId, clientRequestId: requestId() };
  ...
  return {
    ...
    async createAutomation(input) {
      ...
      const payload = { workspaceId: input.workspaceId, clientRequestId, input };
    ...
    async updateAutomation(automationId, expectedRevision, input) {
      const payload = { automationId, expectedRevision, input, clientRequestId: requestId() };
      await mutateThenRefresh("update", payload);
    },
    async mutateAutomation(automationId, mutation) {
      const payload = { automationId, mutation, clientRequestId: requestId() };
      await mutateThenRefresh("mutate", payload);
    },
    async runNow(automationId) {
      const payload = { automationId, clientRequestId: requestId() };
    ...
    async reviewRun(runId, action) {
      const payload = { runId, action, clientRequestId: requestId() };
...
.dsh-automation-shell{width:100%;height:100%;min-height:0;container-name:dsh-automation;container-type:inline-size;overflow:auto;overscroll-behavior:contain;padding:28px clamp(20px,3vw,48px) calc(var(--dsh-composer-height,152px) + 36px);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-primary);font-family:var(--dsw-font-family,system-ui);scrollbar-gutter:stable}
...
.dsh-automation-scope{justify-content:space-between}.dsh-automation-scope label{display:flex;min-width:0;align-items:center;gap:7px}.dsh-automation-scope select{min-width:180px;height:30px;padding:4px 28px 4px 9px;border:1px solid var(--dsw-alias-border-l2);border-radius:7px;background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-primary);font:11px/17px var(--dsw-font-family,system-ui)}
...
.dsh-automation-card-badges{display:flex;flex-wrap:wrap;align-items:center;gap:5px}.dsh-automation-badge,.dsh-automation-permission-badge{display:inline-flex;align-items:center;gap:5px;padding:2px 7px;border:1px solid var(--dsw-alias-border-l2);border-radius:999px;color:var(--dsw-alias-label-secondary);font-size:10px;font-weight:600;line-height:15px}.dsh-automation-status-dot{width:6px;height:6px;border-radius:50%;background:var(--dsw-alias-label-tertiary)}.dsh-automation-badge--active{border-color:color-mix(in srgb,var(--dsw-alias-state-success-primary) 30%,var(--dsw-alias-border-l2));background:var(--dsw-alias-state-success-tertiary);color:var(--dsw-alias-state-success-primary)}.dsh-automation-badge--active .dsh-automation-status-dot{background:var(--dsw-alias-state-success-primary);box-shadow:0 0 0 3px color-mix(in srgb,var(--dsw-alias-state-success-primary) 12%,transparent)}.dsh-automation-badge--paused{background:var(--dsw-alias-bg-layer-2);color:var(--dsw-alias-label-tertiary)}.dsh-automation-permission-badge svg{width:12px;height:12px}
.dsh-automation-health-badge{display:inline-flex;padding:2px 7px;border:1px solid color-mix(in srgb,var(--dsw-alias-state-error-primary) 35%,var(--dsw-alias-border-l2));border-radius:999px;background:var(--dsw-alias-state-error-secondary);color:var(--dsw-alias-state-error-primary);font-size:10px;font-weight:650;line-height:15px}.dsh-automation-health{display:flex;align-items:flex-start;gap:7px;margin:-3px 0 12px;padding:8px 9px;border:1px solid color-mix(in srgb,var(--dsw-alias-state-error-primary) 30%,var(--dsw-alias-border-l2));border-radius:8px;background:var(--dsw-alias-state-error-secondary);color:var(--dsw-alias-state-error-primary);font-size:10px;line-height:16px}.dsh-automation-health svg{width:14px;height:14px;flex:none}
...
.dsh-automation-run-phase,.dsh-automation-run-model{display:block;margin-top:4px;color:var(--dsw-alias-label-tertiary);font-size:9px;line-height:14px}.dsh-automation-run-phase{color:var(--dsw-alias-state-business-primary);font-weight:650}
...
.dsh-automation-segmented--two{grid-template-columns:repeat(2,minmax(130px,1fr))}.dsh-automation-model-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:12px;margin-top:10px}.dsh-automation-model-hint{margin:8px 0 0;color:var(--dsw-alias-label-secondary);font-size:10px;line-height:16px}
.dsh-automation-schedule-preview{display:flex;grid-column:1/-1;align-items:center;gap:7px;padding:8px 10px;border:1px solid color-mix(in srgb,var(--dsw-alias-state-business-primary) 24%,var(--dsw-alias-border-l2));border-radius:8px;background:var(--dsw-alias-state-business-tertiary);color:var(--dsw-alias-state-business-primary);font-size:11px;line-height:17px}.dsh-automation-schedule-preview svg{width:14px;height:14px;flex:none}
...
.dsh-automation-migration{display:flex;max-width:1440px;align-items:center;gap:8px;margin:0 auto 14px;padding:9px 11px;border:1px solid color-mix(in srgb,var(--dsw-alias-state-success-primary) 30%,var(--dsw-alias-border-l2));border-radius:9px;background:var(--dsw-alias-state-success-tertiary);color:var(--dsw-alias-state-success-primary);font-size:11px;line-height:17px}.dsh-automation-migration svg{width:15px;height:15px;flex:none}
...
.dsh-automation-error-code{display:block;width:max-content;margin-top:6px;padding:2px 6px;border:1px solid color-mix(in srgb,var(--dsw-alias-state-error-primary) 28%,var(--dsw-alias-border-l2));border-radius:5px;background:var(--dsw-alias-state-error-secondary);color:var(--dsw-alias-state-error-primary);font:9px/14px ui-monospace,SFMono-Regular,Menlo,monospace}.dsh-automation-run-review{display:inline-flex;align-items:center;gap:4px;margin-top:7px;padding:2px 7px;border:1px solid var(--dsw-alias-border-l2);border-radius:6px;background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);font:600 9px/14px var(--dsw-font-family,system-ui);cursor:pointer}.dsh-automation-run-review svg{width:11px;height:11px}.dsh-automation-run-review:hover:not(:disabled){border-color:color-mix(in srgb,var(--dsw-alias-state-business-primary) 38%,var(--dsw-alias-border-l2));color:var(--dsw-alias-state-business-primary)}.dsh-automation-run-review:disabled{cursor:not-allowed;opacity:.45}
.dsh-automation-shell button:focus-visible,.dsh-automation-shell input:focus-visible,.dsh-automation-shell textarea:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:2px}
...
@container dsh-automation (max-width:1100px){.dsh-automation-content{grid-template-columns:1fr}.dsh-automation-runs-column{position:static}.dsh-automation-run-list{display:grid;grid-template-columns:repeat(2,minmax(0,1fr))}.dsh-automation-run:nth-child(odd){border-right:1px solid var(--dsw-alias-border-l2)}.dsh-automation-run:nth-last-child(-n+2){border-bottom:0}}
@container dsh-automation (max-width:760px){.dsh-automation-shell{padding:18px 14px 24px}.dsh-automation-header{align-items:center}.dsh-automation-heading p{display:none}.dsh-automation-logo{width:38px;height:38px;border-radius:12px}.dsh-automation-stats{grid-template-columns:1fr 1fr}.dsh-automation-scope{align-items:flex-start;flex-direction:column;gap:4px}.dsh-automation-form-grid,.dsh-automation-schedule-fields,.dsh-automation-permission-grid,.dsh-automation-model-grid{grid-template-columns:1fr}.dsh-automation-segmented{width:100%;grid-template-columns:1fr 1fr}.dsh-automation-card-times{grid-template-columns:1fr}.dsh-automation-card-times>div{padding-right:0;border-right:0}.dsh-automation-run-list{grid-template-columns:1fr}.dsh-automation-run:nth-child(odd){border-right:0}.dsh-automation-run:nth-last-child(2){border-bottom:1px solid var(--dsw-alias-border-l2)}}
@container dsh-automation (max-width:480px){.dsh-automation-header{align-items:flex-start;flex-direction:column}.dsh-automation-header>.dsh-automation-button{width:100%}.dsh-automation-heading h1{font-size:21px}.dsh-automation-stats{gap:7px}.dsh-automation-stats>div{min-height:68px;padding:10px 12px}.dsh-automation-card{padding:13px}.dsh-automation-schedule-line{align-items:flex-start;flex-wrap:wrap}.dsh-automation-schedule-line span{width:100%;margin-left:21px}.dsh-automation-card-actions{display:grid;grid-template-columns:1fr 1fr}.dsh-automation-card-actions>.dsh-automation-icon-button{position:absolute;right:28px}.dsh-automation-delete-confirm{align-items:stretch;flex-direction:column}.dsh-automation-delete-confirm>div:last-child{justify-content:flex-end}.dsh-automation-create{padding:14px}.dsh-automation-create-heading{flex-direction:column}.dsh-automation-create-heading>.dsh-automation-button{display:none}}
...
// src/client/AutomationSidebarAction.tsx
...
function AutomationSidebarAction({
  t,
  renderAction,
  useAutomationState,
  useShellSurface,
  ...
  const attention = state.snapshot?.runs.filter((run) => run.unread !== false && (run.attention === void 0 ? run.status === "failed" || run.status === "interrupted" || run.status === "skipped" : run.attention !== "none")).length ?? 0;
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_jsx_runtime2.Fragment, { children: renderAction({
    label: t("tab"),
    icon: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(AutomationIcon, {}),
    active,
    ...attention === 0 ? {} : {
...
function localDateTimeValue(date = /* @__PURE__ */ new Date()) {
  ...
  const offset2 = future.getTimezoneOffset() * 6e4;
  return new Date(future.getTime() - offset2).toISOString().slice(0, 16);
}
function defaultFormState(now2 = /* @__PURE__ */ new Date(), workspaceId = "", agentPreset = "standard") {
  return {
    name: "",
    prompt: "",
    scheduleKind: "daily",
    onceAt: localDateTimeValue(now2),
    everyMinutes: "60",
    time: "09:00",
    weekdays: [1, 2, 3, 4, 5],
...
function exactLocalDateTimeValue(iso) {
  ...
  const offset2 = date.getTimezoneOffset() * 6e4;
  return new Date(date.getTime() - offset2).toISOString().slice(0, 16);
}
function formStateFromAutomation(automation) {
  ...
  return {
    ...
    reasoningEffort: automation.modelPolicy.mode === "pinned" ? automation.modelPolicy.reasoningEffort ?? "" : "",
    runTimeoutMinutes: String(automation.runTimeoutMinutes)
  };
}
function buildCreateInput(form, now2 = /* @__PURE__ */ new Date()) {
  ...
  if (!Number.isInteger(runTimeoutMinutes) || runTimeoutMinutes < 1 || runTimeoutMinutes > 1440) {
  ...
  switch (form.scheduleKind) {
    case "once": {
      ...
      if (!Number.isFinite(at.getTime()) || at.getTime() <= now2.getTime()) {
    ...
    case "interval": {
      ...
      schedule = {
        kind: "interval",
        everyMinutes,
        anchor: form.intervalAnchor ?? now2.toISOString(),
  ...
  return {
    ...
    modelPolicy: form.modelMode === "inherit" ? { mode: "inherit" } : {
      mode: "pinned",
...
function previewNextRun(form, now2 = /* @__PURE__ */ new Date()) {
  try {
    const common = { timeZone: form.timeZone };
    const schedule = form.scheduleKind === "once" ? { kind: "once", at: new Date(form.onceAt).toISOString(), ...common } : form.scheduleKind === "interval" ? {
      kind: "interval",
      everyMinutes: Number(form.everyMinutes),
      anchor: form.intervalAnchor ?? now2.toISOString(),
      ...common
    } : form.scheduleKind === "daily" ? { kind: "daily", time: form.time, ...common } : {
      kind: "weekly",
      time: form.time,
      weekdays: form.weekdays.map((day) => ["MO", "TU", "WE", "TH", "FR", "SA", "SU"][day - 1]),
      ...common
    };
    return nextOccurrence(schedule, now2.toISOString()) ?? void 0;
  } catch {
    return void 0;
  }
}
...
function buildUpdateInput(form, automation, now2 = /* @__PURE__ */ new Date()) {
  const name2 = form.name.trim();
  const prompt = form.prompt.trim();
  if (name2 === "") throw new AutomationFormError("form.error.name");
  if (prompt === "") throw new AutomationFormError("form.error.prompt");
  ...
  const replacement = scheduleChanged ? buildCreateInput(form, now2) : void 0;
  return {
    ...
    ...JSON.stringify(form.modelMode === "inherit" ? { mode: "inherit" } : {
      mode: "pinned",
      provider: form.modelProvider,
      model: form.model,
      ...form.reasoningEffort === "" ? {} : { reasoningEffort: form.reasoningEffort }
    ...
    ...runTimeoutMinutes === automation.runTimeoutMinutes ? {} : { runTimeoutMinutes }
  };
}
...
function deriveOverview(snapshot) {
  ...
  return {
    ...
    attention: snapshot.runs.filter((run) => run.unread !== false && (run.attention === void 0 ? ATTENTION_STATUSES.has(run.status) : run.attention !== "none")).length,
    ...next === void 0 ? {} : { nextRunAt: next }
  };
}
function formatRelativeTime2(iso, now2, t) {
  const value = Date.parse(iso);
  if (!Number.isFinite(value)) return iso;
  const deltaMinutes = Math.round((value - now2.getTime()) / 6e4);
...
function AutomationStatusBadge({ status, t }) {
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { className: `dsh-automation-badge dsh-automation-badge--${status}`, children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "dsh-automation-status-dot" }),
    t(`status.${status}`)
  ] });
}
function RunStatusBadge({ status, t }) {
  const icon = status === "succeeded" ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(CheckIcon, {}) : status === "failed" || status === "interrupted" ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(AlertIcon, {}) : status === "running" || status === "queued" ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(AutomationIcon, {}) : void 0;
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { className: `dsh-automation-run-status dsh-automation-run-status--${status}`, children: [
    icon,
...
function AutomationForm(props) {
  ...
  const [form, setForm] = (0, import_react2.useState)(() => props.mode === "create" ? defaultFormState(
    /* @__PURE__ */ new Date(),
    workspaces[0]?.id ?? "",
  ...
  const nextPreview = (0, import_react2.useMemo)(() => previewNextRun(form), [form]);
  const providers = (0, import_react2.useMemo)(() => [...new Map(models.map((model) => [model.provider, {
    id: model.provider,
  ...
  const setModelMode = (mode) => {
    ...
    const selected = models.find((model) => model.provider === defaultModel.provider && model.model === defaultModel.model) ?? models[0];
    setForm((current) => ({
      ...current,
      modelMode: mode,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("form", { className: "dsh-automation-create", onSubmit: submit, children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dsh-automation-create-heading", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "dsh-automation-kicker", children: t("header.eyebrow") }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("h2", { children: t(props.mode === "create" ? "form.title" : "form.editTitle") }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { children: t(props.mode === "create" ? "form.subtitle" : "form.editSubtitle") })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { className: "dsh-automation-button dsh-automation-button--ghost", type: "button", onClick: onCancel, disabled: busy, children: t("form.cancel") })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dsh-automation-form-grid", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("label", { className: "dsh-automation-field", children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { children: t("form.workspace") }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("select", { value: form.workspaceId, disabled: props.mode === "edit", onChange: (event) => update("workspaceId", event.currentTarget.value), children: [
          workspaces.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("option", { value: "", children: t("form.workspaceEmpty") }),
          workspaces.map((workspace) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("option", { value: workspace.id, children: workspace.title }, workspace.id))
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("label", { className: "dsh-automation-field", children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { children: t("form.name") }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("input", { value: form.name, maxLength: 80, placeholder: t("form.namePlaceholder"), onChange: (event) => update("name", event.currentTarget.value) })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("label", { className: "dsh-automation-field", children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { children: t("form.agentPreset") }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("select", { value: form.agentPreset, onChange: (event) => update("agentPreset", event.currentTarget.value), children: presets.filter((preset) => !preset.broken).map((preset) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("option", { value: preset.id, children: preset.name }, preset.id)) })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("label", { className: "dsh-automation-field", children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { children: t("form.timeout") }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { className: "dsh-automation-inline-input", children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("input", { type: "number", min: 1, max: 1440, value: form.runTimeoutMinutes, onChange: (event) => update("runTimeoutMinutes", event.currentTarget.value) }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { children: t("form.minutes") })
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("fieldset", { className: "dsh-automation-fieldset dsh-automation-field--wide", children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("legend", { children: t("form.modelPolicy") }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "dsh-automation-segmented dsh-automation-segmented--two", children: ["inherit", "pinned"].map((mode) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
          "button",
          {
            type: "button",
            ...
            children: t(mode === "inherit" ? "form.modelInherit" : "form.modelPinned")
          },
          mode
        )) }),
        form.modelMode === "inherit" ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "dsh-automation-model-hint", children: t("form.modelInheritHint", {
          provider: defaultModel.provider,
          model: defaultModel.model
        }) }) : /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dsh-automation-model-grid", children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("label", { className: "dsh-automation-field", children: [
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { children: t("form.provider") }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("select", { value: form.modelProvider, onChange: (event) => {
            ...
            }, children: providers.map((provider) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("option", { value: provider.id, children: provider.name }, provider.id)) })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("label", { className: "dsh-automation-field", children: [
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { children: t("form.model") }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("select", { value: form.model, onChange: (event) => {
              update("model", event.currentTarget.value);
              update("reasoningEffort", "");
            }, children: providerModels.map((model) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("option", { value: model.model, children: model.modelName }, model.model)) })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("label", { className: "dsh-automation-field", children: [
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { children: t("form.reasoningEffort") }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("select", { value: form.reasoningEffort, onChange: (event) => update("reasoningEffort", event.currentTarget.value), children: [
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("option", { value: "", children: t("form.reasoningDefault") }),
              selectedModel?.reasoningEfforts.map((effort) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("option", { value: effort.id, children: effort.name }, effort.id))
            ] })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("label", { className: "dsh-automation-field dsh-automation-field--wide", children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { children: t("form.prompt") }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("textarea", { value: form.prompt, maxLength: 12e3, rows: props.mode === "edit" ? 8 : 4, placeholder: t("form.promptPlaceholder"), onChange: (event) => update("prompt", event.currentTarget.value) })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("fieldset", { className: "dsh-automation-fieldset dsh-automation-field--wide", children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("legend", { children: t("form.schedule") }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "dsh-automation-segmented", children: ["once", "interval", "daily", "weekly"].map((kind) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
          "button",
          {
            type: "button",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dsh-automation-schedule-fields", children: [
          form.scheduleKind === "once" && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("label", { className: "dsh-automation-field", children: [
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { children: t("form.runAt") }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("input", { type: "datetime-local", value: form.onceAt, onChange: (event) => update("onceAt", event.currentTarget.value) })
          ] }),
          form.scheduleKind === "interval" && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("label", { className: "dsh-automation-field", children: [
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { children: t("form.every") }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { className: "dsh-automation-inline-input", children: [
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("input", { type: "number", min: 5, max: 43200, value: form.everyMinutes, onChange: (event) => update("everyMinutes", event.currentTarget.value) }),
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { children: t("form.minutes") })
            ] })
          ] }),
          (form.scheduleKind === "daily" || form.scheduleKind === "weekly") && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("label", { className: "dsh-automation-field", children: [
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { children: t("form.time") }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("input", { type: "time", value: form.time, onChange: (event) => update("time", event.currentTarget.value) })
          ] }),
          form.scheduleKind === "weekly" && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dsh-automation-field dsh-automation-weekdays", children: [
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { children: t("form.days") }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { children: WEEKDAYS.map((day) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { type: "button", "aria-pressed": form.weekdays.includes(day), className: form.weekdays.includes(day) ? "is-selected" : "", onClick: () => toggleWeekday(day), children: t(`day.${day}`) }, day)) })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("label", { className: "dsh-automation-field", children: [
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { children: t("form.timeZone") }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("input", { value: form.timeZone, onChange: (event) => update("timeZone", event.currentTarget.value) })
          ] }),
          nextPreview !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dsh-automation-schedule-preview", role: "status", children: [
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(CalendarIcon, {}),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { children: t("form.nextPreview", {
              time: new Date(nextPreview).toLocaleString(void 0, {
                year: "numeric",
                month: "short",
                day: "numeric",
                hour: "2-digit",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("fieldset", { className: "dsh-automation-fieldset dsh-automation-field--wide", children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("legend", { children: t("form.reviewMode") }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "dsh-automation-segmented dsh-automation-segmented--two", children: ["direct", "worktree"].map((mode) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
          "button",
          {
            type: "button",
            ...
            onClick: () => setForm((current) => ({
              ...current,
              reviewMode: mode,
              ...mode === "worktree" ? { permission: "workspace-write" } : {}
            })),
            children: t(mode === "direct" ? "form.reviewDirect" : "form.reviewWorktree")
          },
          mode
        )) }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "dsh-automation-model-hint", children: t(form.reviewMode === "worktree" ? "form.reviewWorktreeHint" : "form.reviewDirectHint") })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("fieldset", { className: "dsh-automation-fieldset dsh-automation-field--wide", children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("legend", { children: t("form.permission") }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "dsh-automation-permission-grid", children: ["read-only", "workspace-write"].map((permission) => /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("label", { className: form.permission === permission ? "is-selected" : "", children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("input", { type: "radio", name: "permission", value: permission, checked: form.permission === permission, onChange: () => setForm((current) => ({
            ...current,
            permission,
            ...permission === "read-only" ? { reviewMode: "direct" } : {}
          })) }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(ShieldIcon, {}),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { children: [
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("strong", { children: t(permission === "read-only" ? "form.readOnly" : "form.workspaceWrite") }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("small", { children: t(permission === "read-only" ? "form.readOnlyHint" : "form.workspaceWriteHint") })
          ] })
        ] }, permission)) })
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dsh-automation-form-footer", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "dsh-automation-form-error", role: "alert", children: validationError }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("button", { className: "dsh-automation-button dsh-automation-button--primary", type: "submit", disabled: busy, children: [
        props.mode === "create" ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(PlusIcon, {}) : /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(PencilIcon, {}),
...
function AutomationCard(props) {
  const { automation, now: now2, t, busyKey, confirmingDelete, onConfirmDelete, onEdit, onMutate, onRun } = props;
  const isBusy = busyKey?.endsWith(`:${automation.id}`) === true;
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("article", { className: "dsh-automation-card", children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dsh-automation-card-top", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dsh-automation-card-title", children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "dsh-automation-card-icon", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(AutomationIcon, {}) }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("h3", { children: automation.name }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dsh-automation-card-badges", children: [
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(AutomationStatusBadge, { status: automation.status, t }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { className: "dsh-automation-permission-badge", children: [
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(ShieldIcon, {}),
              t(`card.permission.${automation.permission}`)
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "dsh-automation-permission-badge", children: automation.workspaceName }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { className: "dsh-automation-permission-badge", children: [
            ...
            automation.reviewMode === "worktree" && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "dsh-automation-permission-badge", children: t("card.reviewWorktree") }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "dsh-automation-permission-badge", children: automation.modelPolicy.mode === "inherit" ? t("card.modelInherit") : `${automation.modelPolicy.provider}/${automation.modelPolicy.model}` }),
            automation.health.status !== "ready" && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "dsh-automation-health-badge", children: t(`card.health.${automation.health.status}`) })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { className: "dsh-automation-revision", children: [
        "v",
        automation.revision
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "dsh-automation-prompt", children: automation.prompt }),
    automation.health.status !== "ready" && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dsh-automation-health", role: "status", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(AlertIcon, {}),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { children: automation.health.issues.map((issue) => issue.message).join(" ") })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("details", { className: "dsh-automation-prompt-details", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("summary", { children: t("card.viewPrompt") }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("pre", { children: automation.prompt })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dsh-automation-schedule-line", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(CalendarIcon, {}),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("strong", { children: formatSchedule(automation.schedule, t) }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { children: automation.timeZone })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("dl", { className: "dsh-automation-card-times", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("dt", { children: t("card.nextRun") }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("dd", { children: automation.status === "active" && automation.nextRunAt !== void 0 ? formatRelativeTime2(automation.nextRunAt, now2, t) : "\u2014" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("dt", { children: t("card.lastRun") }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("dd", { children: automation.lastRunAt === void 0 ? t("card.never") : /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: `dsh-automation-mini-dot dsh-automation-mini-dot--${automation.lastRunStatus ?? "succeeded"}` }),
          formatRelativeTime2(automation.lastRunAt, now2, t)
        ] }) })
      ] })
    ] }),
    confirmingDelete ? /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dsh-automation-delete-confirm", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("strong", { children: t("card.confirmDelete") }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { children: t("card.confirmDeleteHint") })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { className: "dsh-automation-button dsh-automation-button--ghost", type: "button", onClick: () => onConfirmDelete(), disabled: isBusy, children: t("card.cancel") }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("button", { className: "dsh-automation-button dsh-automation-button--danger", type: "button", onClick: () => onMutate(automation.id, "delete"), disabled: isBusy, children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(TrashIcon, {}),
          t("card.confirm")
        ] })
      ] })
    ] }) : /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dsh-automation-card-actions", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("button", { className: "dsh-automation-button dsh-automation-button--ghost", type: "button", onClick: () => onEdit(automation), disabled: isBusy, children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(PencilIcon, {}),
        t("card.edit")
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("button", { className: "dsh-automation-button dsh-automation-button--ghost", type: "button", onClick: () => onRun(automation.id), disabled: isBusy || automation.health.status === "blocked", title: automation.health.issues[0]?.message, children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(PlayIcon, {}),
        t("card.runNow")
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("button", { className: "dsh-automation-button dsh-automation-button--ghost", type: "button", onClick: () => onMutate(automation.id, automation.status === "active" ? "pause" : "resume"), disabled: isBusy, children: [
        automation.status === "active" ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(PauseIcon, {}) : /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(PlayIcon, {}),
        t(automation.status === "active" ? "card.pause" : "card.resume")
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { className: "dsh-automation-icon-button", type: "button", "aria-label": t("card.delete"), title: t("card.delete"), onClick: () => onConfirmDelete(automation.id), disabled: isBusy, children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(TrashIcon, {}) })
    ] })
  ] });
}
function RecentRun({ run, now: now2, t, busy, onOpen, onMarkRead, onCancel, onReview }) {
  const timestamp = run.finishedAt ?? run.startedAt ?? run.scheduledFor;
  const canMarkRead = run.unread !== false && (run.attention === void 0 ? run.status === "failed" || run.status === "interrupted" || run.status === "skipped" || run.status === "cancelled" : run.attention !== "none");
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("article", { className: "dsh-automation-run", children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dsh-automation-run-head", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "dsh-automation-run-name", children: run.automationName }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "dsh-automation-run-trigger", children: t(`run.trigger.${run.trigger}`) })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("time", { dateTime: timestamp, children: formatRelativeTime2(timestamp, now2, t) })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(RunStatusBadge, { status: run.status, t }),
    run.outcome !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "dsh-automation-run-phase", children: t(`outcome.${run.outcome}`) }),
    run.attempt !== void 0 && run.attempt > 1 && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "dsh-automation-run-model", children: t("run.attempt", { count: run.attempt }) }),
    run.effect?.status === "unknown" && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "dsh-automation-run-model", children: t("run.effectUnknown") }),
    run.phase !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "dsh-automation-run-phase", children: t(`phase.${run.phase}`) }),
    run.effectiveModel !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { className: "dsh-automation-run-model", children: [
      run.effectiveModel.provider,
      "/",
      run.effectiveModel.model,
      run.effectiveModel.reasoningEffort === void 0 ? "" : ` \xB7 ${run.effectiveModel.reasoningEffort}`
    ] }),
    (run.summary !== void 0 || run.error !== void 0) && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: run.error === void 0 ? "" : "is-error", children: run.error ?? run.summary }),
    run.errorCode !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("code", { className: "dsh-automation-error-code", children: run.errorCode }),
    run.sessionId !== void 0 && run.sessionArchived && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "dsh-automation-session-id dsh-automation-session-id--archived", title: run.sessionId, children: t("run.sessionArchived", { id: shortSessionId(run.sessionId) }) }),
    run.sessionId !== void 0 && !run.sessionArchived && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { className: "dsh-automation-session-id", type: "button", onClick: () => onOpen(run.id, run.sessionId), children: t("run.openSession", { id: shortSessionId(run.sessionId) }) }),
    canMarkRead && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("button", { className: "dsh-automation-run-review", type: "button", onClick: () => onMarkRead(run.id), disabled: busy, children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(CheckIcon, {}),
      t("run.markRead")
    ] }),
    (run.status === "queued" || run.status === "running") && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("button", { className: "dsh-automation-run-review", type: "button", title: t("run.cancelHint"), onClick: () => onCancel(run.id), disabled: busy, children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(PauseIcon, {}),
      t("run.cancel")
    ] }),
    run.review?.cleanup.status === "settling" && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "dsh-automation-run-model", children: t("run.reviewSettling") }),
    run.review?.cleanup.status === "unknown" && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "dsh-automation-run-model", children: t("run.reviewCleanupUnknown") }),
    run.review !== void 0 && run.review.cleanup.status === "owned" && (run.review.status === "ready" || run.review.status === "kept") && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dsh-automation-card-actions", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "dsh-automation-run-model", children: run.review.diffStat ?? t("run.reviewPending") }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { className: "dsh-automation-button dsh-automation-button--ghost", type: "button", onClick: () => onReview(run.id, "accept"), disabled: busy, children: t("run.reviewAccept") }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { className: "dsh-automation-button dsh-automation-button--ghost", type: "button", onClick: () => onReview(run.id, "keep"), disabled: busy, children: t("run.reviewKeep") }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { className: "dsh-automation-button dsh-automation-button--danger", type: "button", onClick: () => onReview(run.id, "discard"), disabled: busy, children: t("run.reviewDiscard") })
    ] })
  ] });
}
function AutomationView({
  ...
  const [editingAutomationId, setEditingAutomationId] = (0, import_react2.useState)();
  const [busyKey, setBusyKey] = (0, import_react2.useState)();
  const [actionError, setActionError] = (0, import_react2.useState)();
  const [confirmDeleteId, setConfirmDeleteId] = (0, import_react2.useState)();
  const [workspaceFilter, setWorkspaceFilter] = (0, import_react2.useState)("");
  const notifiedRunIds = (0, import_react2.useRef)(/* @__PURE__ */ new Set());
  ...
  (0, import_react2.useEffect)(() => {
    if (snapshot === void 0 || typeof Notification === "undefined" || Notification.permission !== "granted") return;
    for (const run of snapshot.runs) {
      if (run.unread === false || run.attention === void 0 || run.attention === "none" || notifiedRunIds.current.has(run.id)) continue;
  ...
  const editingAutomation = (0, import_react2.useMemo)(
    () => snapshot?.automations.find((item) => String(item.id) === editingAutomationId),
    [editingAutomationId, snapshot]
  );
  const filteredSnapshot = (0, import_react2.useMemo)(() => snapshot === void 0 ? void 0 : {
    ...snapshot,
    automations: workspaceFilter === "" ? snapshot.automations : snapshot.automations.filter((item) => item.workspaceId === workspaceFilter),
    runs: workspaceFilter === "" ? snapshot.runs : snapshot.runs.filter((run) => snapshot.automations.find((item) => item.id === run.automationId)?.workspaceId === workspaceFilter)
  }, [snapshot, workspaceFilter]);
  const stats = (0, import_react2.useMemo)(() => filteredSnapshot === void 0 ? void 0 : deriveOverview(filteredSnapshot), [filteredSnapshot]);
  const now2 = (0, import_react2.useMemo)(() => new Date(snapshot?.serverNow ?? Date.now()), [snapshot?.serverNow]);
  ...
  const onMutate = (id, mutation) => {
    void perform(actionKey(mutation, id), async () => {
      ...
      if (mutation === "delete") {
        ...
        if (editingAutomationId === id) setEditingAutomationId(void 0);
      }
    });
  };
  const onRun = (id) => {
  ...
  if (snapshot === void 0 && (state.phase === "idle" || state.phase === "loading")) {
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dsh-automation-shell dsh-automation-centered", role: "status", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "dsh-automation-loader", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(AutomationIcon, {}) }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { children: t("loading") })
    ] });
  }
  if (snapshot === void 0) {
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dsh-automation-shell dsh-automation-centered", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "dsh-automation-error-icon", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(AlertIcon, {}) }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("h2", { children: t("error.title") }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { children: state.error }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("button", { className: "dsh-automation-button dsh-automation-button--primary", type: "button", onClick: () => {
        void refresh().catch(() => void 0);
      }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(RefreshIcon, {}),
        t("error.retry")
      ] })
    ] });
  }
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dsh-automation-shell", children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("header", { className: "dsh-automation-header", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dsh-automation-heading", children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "dsh-automation-logo", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(AutomationIcon, {}) }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "dsh-automation-kicker", children: t("header.eyebrow") }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("h1", { children: t("header.title") }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { children: t("header.subtitle") })
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("button", { className: "dsh-automation-button dsh-automation-button--primary", type: "button", disabled: snapshot.workspaces.length === 0, title: snapshot.workspaces.length === 0 ? t("form.workspaceEmpty") : void 0, onClick: () => {
        setEditingAutomationId(void 0);
        setShowCreate((value) => !value);
      }, children: [
        showCreate ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(PauseIcon, {}) : /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(PlusIcon, {}),
        showCreate ? t("header.closeCreate") : t("header.create")
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dsh-automation-scope", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("label", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("strong", { children: t("scope.workspace") }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("select", { value: workspaceFilter, onChange: (event) => setWorkspaceFilter(event.currentTarget.value), children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("option", { value: "", children: t("scope.allWorkspaces") }),
          snapshot.workspaces.map((workspace) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("option", { value: workspace.id, children: workspace.title }, workspace.id))
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { children: t("scope.workspaceCount", { count: snapshot.workspaces.length }) })
    ] }),
    snapshot.migration.detectedDefinitions + snapshot.migration.detectedRuns > 0 && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dsh-automation-migration", role: "status", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(CheckIcon, {}),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { children: t("migration.summary", {
    ...
    showCreate && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
      AutomationForm,
      {
        mode: "create",
        t,
    ...
    editingAutomation !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
      AutomationForm,
      {
        mode: "edit",
        ...
        onCancel: () => setEditingAutomationId(void 0),
        onSubmit: onUpdate
      },
      `${editingAutomation.id}:${editingAutomation.revision}`
    ),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("section", { className: "dsh-automation-stats", "aria-label": t("header.title"), children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { children: t("stats.total") }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("strong", { children: stats?.total ?? 0 })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { children: t("stats.active") }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("strong", { children: stats?.active ?? 0 })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { children: t("stats.next") }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("strong", { children: stats?.nextRunAt === void 0 ? t("stats.noneScheduled") : formatRelativeTime2(stats.nextRunAt, now2, t) })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: (stats?.attention ?? 0) > 0 ? "is-attention" : "", children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { children: t("stats.attention") }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("strong", { children: (stats?.attention ?? 0) === 0 ? t("stats.noAttention") : stats?.attention })
      ] })
    ] }),
    (actionError !== void 0 || state.error !== void 0) && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dsh-automation-inline-error", role: "alert", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(AlertIcon, {}),
      actionError ?? state.error
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dsh-automation-content", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("section", { className: "dsh-automation-main-column", children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dsh-automation-section-heading", children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { children: [
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("h2", { children: t("section.automations") }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { children: t("section.automationsHint") })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { className: "dsh-automation-icon-button", type: "button", "aria-label": t("section.refresh"), title: t("section.refresh"), onClick: () => {
            void refresh().catch(() => void 0);
          }, disabled: state.phase === "loading", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(RefreshIcon, {}) })
        ] }),
        filteredSnapshot?.automations.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dsh-automation-empty", children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(AutomationIcon, {}) }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("h3", { children: t("empty.title") }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { children: t("empty.body") }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("button", { className: "dsh-automation-button dsh-automation-button--primary", type: "button", disabled: snapshot.workspaces.length === 0, title: snapshot.workspaces.length === 0 ? t("form.workspaceEmpty") : void 0, onClick: () => setShowCreate(true), children: [
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(PlusIcon, {}),
            t("empty.action")
          ] })
        ] }) : /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "dsh-automation-card-list", children: filteredSnapshot?.automations.map((automation) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
          AutomationCard,
          {
            automation,
            now: now2,
      ...
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("aside", { className: "dsh-automation-runs-column", children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "dsh-automation-section-heading", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("h2", { children: t("section.runs") }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { children: t("section.runsHint") })
        ] }) }),
        filteredSnapshot?.runs.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "dsh-automation-runs-empty", children: t("runs.empty") }) : /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "dsh-automation-run-list", children: filteredSnapshot?.runs.slice(0, 12).map((run) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
          RecentRun,
          {
            run,
            now: now2,
...
// src/client/surface.tsx
var import_jsx_runtime4 = require("react/jsx-runtime");
function pageShares(ctx, runtime, showConversation) {
  return {
...
function ConversationAutomationView(props) {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dsh-automation-conversation-surface", "data-conversation-composer-overlay": "", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(AutomationView, { ...props }) });
}
function SettingsAutomationView(props) {
...
function registerSettingsSection(ctx, runtime, t) {
  ctx.slots.inject("settings.section", () => ctx.slots.register({
    ...
    locale: NS,
    label: () => t("tab"),
    inject: () => pageShares(ctx, runtime, () => void 0)
  }, SettingsAutomationView));
}
function registerNativeShell(ctx, runtime) {
  const layout = ctx.layout;
  if (layout?.surface === void 0 || layout.openPage === void 0 || layout.showConversation === void 0) {
  ...
  ctx.slots.inject("sidebar.primary.action", () => ctx.slots.register({
    ...
    inject: () => ({
      ...
      refresh: runtime.refresh,
      open: () => {
        layout.openPage?.("automation");
      }
    })
  }, AutomationSidebarAction));
}
function registerConversationFallback(ctx, runtime, t) {
...
function registerAutomationSurface(ctx, runtime, t) {
  registerSettingsSection(ctx, runtime, t);
  const hasNativeNavigation = ctx.layout?.surface !== void 0 && ctx.layout.openPage !== void 0 && ctx.layout.showConversation !== void 0;
...
// src/client/index.ts
var name = "dsh-automation-center-client";
var inject = ["slots", "locale", "connection", "sessions", "layout"];
function apply(ctx) {
